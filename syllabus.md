...
Office Hours:
  * Virtual:  Mondays, Wednesdays 4:15pm - 5:15pm (zoom link will be posted to piazza)
  * In-person:  Fridays 9:00am - 10:00am 

Contact:

* [Piazza]((https://www.piazza.com/gvsu/fall2021/cis241/home) **preferred**
...
* In this course we'll use a system called
  ...
  edit can be a simple as correcting a typo, capitalizaiton, or even
...
and one or more coding questions.  The midterm exam will be taken
...
basic command line navigation.  This quiz will be graded based on your
ability to illustrate to me that you are reasonably fluent on the command line.
...
* **Projects**:  should be completed individually.  This means that
  ...
  code.  You are not allowed to copy code from online (even if you change
...
housing, food, and textbooks) that a student could not otherwise
